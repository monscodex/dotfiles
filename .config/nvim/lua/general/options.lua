local options = {
    ...
    wildmenu = true,                         -- better menu completion when pressing <Tab>
    ...
    title = true,                            -- set the window's title to the file name
    ...
    -- Miscellaneous
    autochdir = true,                        -- automatically change directory to the file's directory
